...
def saoComplementosOrtogonais(arg1, arg2):
  if isinstance(arg1, Reta) and isinstance(arg2, Plano):
...
def formaCartesiana(arg):
  if isinstance(arg, Plano):
...
def intersecao(arg1, arg2): 
  if isinstance(arg1, Reta) and isinstance(arg2, Reta):
    reta1 = arg1
    reta2 = arg2
  ...
  if isinstance(arg1, Reta) and isinstance(arg2, Esfera):
    reta = arg1
    esfera = arg2
  ...
  if isinstance(arg1, Reta) and isinstance(arg2, Triangulo):
    reta = arg1
    triangulo = arg2
    ...
    pontoIntersec = intersecao(reta, planoTriangulo)
  ...
  if isinstance(arg1, Plano) and isinstance(arg2, Plano):
    plano1 = arg1
    plano2 = arg2
